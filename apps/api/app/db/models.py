...
class UserAccessCredential(TimestampMixin, Base):
    __tablename__ = "user_access_credentials"
    __table_args__ = (
        UniqueConstraint("user_id", name="uq_user_access_credentials_user_id"),
    )
    ...
    access_code_hash: Mapped[str] = mapped_column(String(128), nullable=False)
